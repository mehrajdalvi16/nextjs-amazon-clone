...
import { ProdcutFindManyArgs } from "../../prodcut/base/ProdcutFindManyArgs";
...
export class CategoryControllerBase {
  ...
  async findProdcuts(
    ...
    const query = plainToClass(ProdcutFindManyArgs, request.query);
    const results = await this.service.findProdcuts(params.id, {
      ...query,
      select: {
        category: {
          select: {
  ...
  @common.Post("/:id/prodcuts")
  @nestAccessControl.UseRoles({
    resource: "Category",
    action: "update",
    possession: "any",
  })
  async connectProdcuts(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: ProdcutWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      prodcuts: {
        connect: body,
  ...
  @common.Patch("/:id/prodcuts")
  @nestAccessControl.UseRoles({
    resource: "Category",
    action: "update",
    possession: "any",
  })
  async updateProdcuts(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: ProdcutWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/prodcuts")
  @nestAccessControl.UseRoles({
    resource: "Category",
    action: "update",
    possession: "any",
  })
  async disconnectProdcuts(
    @common.Param() params: CategoryWhereUniqueInput,
    @common.Body() body: ProdcutWhereUniqueInput[]
  ): Promise<void> {
    const data = {
