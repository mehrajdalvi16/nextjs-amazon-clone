...
export class ReviewResolverBase {
  ...
  async createReview(@graphql.Args() args: CreateReviewArgs): Promise<Review> {
    return await this.service.createReview({
      ...
      data: {
        ...
        prodcuts: args.data.prodcuts
          ? {
              connect: args.data.prodcuts,
            }
          : undefined,
  ...
  async getProdcuts(@graphql.Parent() parent: Review): Promise<Prodcut | null> {
    const result = await this.service.getProdcuts(parent.id);
